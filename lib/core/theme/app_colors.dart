...
class AppColors {
  ...
  static const Color surfaceDim = Color(0xFFF5F2FE); // legacy from HEAD
  ...
  // Text Colors
  static const Color textPrimary = Color(0xFF111827); // Note: 0xFF1B1B23 in HEAD
  static const Color textSecondary = Color(0xFF374151); // Note: 0xFF464554 in HEAD
